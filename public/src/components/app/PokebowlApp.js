    ...
    onRender(dom) {
        ...
        function attack() {
            ...
            if(harm > 0) {
                ...
                textFieldContent = [];
                textFieldContent.push(`${opponentPokemon.pokemon} used ${defenseOption} to ${defenseAdvAdjOption} your ${userPokemon.pokemon}'s attack and took no points of damage!`); 
                textFieldContent.push(`${opponentPokemon.pokemon} is about to attack! Defend!`);
                consoleProps.textFieldContent = textFieldContent;
